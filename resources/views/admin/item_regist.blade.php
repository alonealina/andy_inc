...
<div class="content_div regist_div">
    <div class="content_title">商品登録</div>
    <form id="form" name="regist_form" action="{{ route('admin.item_store') }}" method="post" enctype="multipart/form-data">
        @if($errors->has('name'))
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                ...
                <option value="{{ $brand->url }}"
                    @if(old('brand') == $brand->name) selected @endif >{{ $brand->name }}</option>
                @endforeach
                </select>
            </div>
        </div>
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::text('deadline', old('deadline'), ['class' => '', 'maxlength' => 30]) }}
            </div>
        </div>
        <div class="flex_form_item">
            <div class="flex_form_title">価格(税抜)</div>
            <div class="flex_form_content">
                {{ Form::text('price', old('price'), ['class' => '', 'maxlength' => 7, 'pattern' => '^[0-9]+$']) }}
            </div>
        </div>
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                <select name="elasticity">
                    ...
                    <option value="あり"
                        @if(old('elasticity') == 'あり') selected @endif>あり</option>
                </select>
            </div>
        </div>
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                <select name="lining">
                    <option value="なし">なし</option>
                    <option value="あり" 
                        @if(old('lining') == 'あり') selected @endif>あり</option>
                </select>
            </div>
        </div>
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                <select name="translucency">
                    <option value="なし">なし</option>
                    <option value="あり"
                        @if(old('translucency') == 'あり') selected @endif>あり</option>
                </select>
            </div>
        </div>
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                ...
                @if(old('genre.ship_flg') == 1) checked @endif >
                ...
                @if(old('genre.new_flg') == 1) checked @endif >
                ...
                @if(old('genre.deadline_flg') == 1) checked @endif >
                ...
                @if(old('genre.add_img_flg') == 1) checked @endif >
                ...
                @if(old('genre.price_down_flg') == 1) checked @endif >
                ...
                @if(old('genre.add_production_flg') == 1) checked @endif >
