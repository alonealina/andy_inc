...
<div class="content_div regist_div">
    <div class="content_title">ゴルフ場編集</div>
    <form id="form" name="regist_form" action="{{ route('admin.course_update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::text('name', old('name', $course->name), ['class' => '', 'maxlength' => 20]) }}
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                ...
                <option value="{{ $name }}"
                    ...
                    @elseif(empty(old('pref')) && $course->pref == $name) selected @endif >{{ $name }}</option>
                @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::text('address', old('address', $course->address), ['class' => 'form_address', 'maxlength' => 50]) }}
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                ...
                <option value="{{ $category->id }}"
                    ...
                    @elseif(empty(old('category_id')) && $course->category_id == $category->id) selected @endif >{{ $category->name }}</option>
                @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::textarea('content1', old('content1', $course->content1), ['class' => 'notice_content_input', 'rows' => 5, 'maxlength' => 3000]) }}
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::textarea('content2', old('content2', $course->content2), ['class' => 'notice_content_input', 'rows' => 5, 'maxlength' => 3000]) }}
            </div>
        </div>
