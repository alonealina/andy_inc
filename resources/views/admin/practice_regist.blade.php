...
<div class="content_div regist_div">
    <div class="content_title">練習場登録</div>
    <form id="form" name="regist_form" action="{{ route('admin.practice_store') }}" method="post" enctype="multipart/form-data">
        @if($errors->has('title'))
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::textarea('content1', old('content1'), ['class' => 'notice_content_input', 'rows' => 5, 'maxlength' => 3000]) }}
            </div>
        </div>
        ...
        <div class="flex_form_item">
            ...
            <div class="flex_form_content">
                {{ Form::textarea('content2', old('content2'), ['class' => 'notice_content_input', 'rows' => 5, 'maxlength' => 3000]) }}
            </div>
        </div>
