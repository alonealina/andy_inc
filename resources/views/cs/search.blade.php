...
@section('content')
<img src="{{ asset('img/items_header.png') }}" class="company_img" alt="">
<div class="item_logo_list">
    <a href="" class="collection_logo_a"><img src="{{ asset('img/all_items_logo.png') }}" class="collection_logo_img" alt=""></a>
...
<div class="search_count_bar">[カテゴリー]：指定なし [検索文字]：指定なし ヒット件数：6118件</div>
...
<div class="item_logo_list_sp">
    <a href="" class="collection_logo_a_sp"><img src="{{ asset('img/all_items_logo.png') }}" class="collection_logo_img" alt=""></a>
...
<div class="search_count_bar_sp">[カテゴリー]：指定なし [検索文字]：指定なし ヒット件数：6118件</div>
