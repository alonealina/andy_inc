...
@section('content')
<img src="{{ asset('img/price_down_header.png') }}" class="company_img" alt="">
<div class="item_logo_list">
    <a href="" class="collection_logo_a"><img src="{{ asset('img/price_down_logo.png') }}" class="collection_logo_img" alt=""></a>
...
<div class="item_logo_list_sp">
    <a href="" class="collection_logo_a_sp"><img src="{{ asset('img/price_down_logo.png') }}" class="collection_logo_img" alt=""></a>
